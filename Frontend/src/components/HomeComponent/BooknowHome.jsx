      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-10 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 text-left lg:mt-32">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black mb-4 sm:mb-6 drop-shadow-md leading-tight">
            ...
            {/* Button */}
            <button className="bg-[#FF7656] text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-[#ff6342] transition-colors duration-300 shadow-md hover:shadow-lg cursor-pointer text-sm sm:text-base w-full sm:w-auto">
              Book Now
            </button>
          </div>
        </div>
